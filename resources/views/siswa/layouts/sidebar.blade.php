    ...
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('siswa/nilaisemester*') ? 'active' : '' }}" aria-current="page"
                        href="siswa/nilaisemester">
                        <i class="fa-solid fa-file-circle-plus me-2"></i> Nilai Akhir Semester
                    </a>
                </li>
