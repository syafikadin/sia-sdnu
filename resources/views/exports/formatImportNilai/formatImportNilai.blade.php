  ...
  <table>
    <thead>
      <tr>
        <td colspan="5" align="center">
          <strong>FORMAT IMPORT NILAI</strong>
        </td>
      </tr>
      <tr>
        <td colspan="2">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
          <strong>NILAI KO1</strong>
        </td>
        <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
          <strong>NILAI KO2</strong>
        </td>
        <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
          <strong>NILAI SUB1</strong>
        </td>
        <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
          <strong>NILAI SUB2</strong>
        </td>
        <td align="center" style="border: 1px solid #000000; background-color: #d9ecd0;">
      ...
      <tr>
        ...
        <td style="border: 1px solid #000000; background-color: #e0eda4;">
          {{$anggota_kelas->siswa->nama_siswa}}
        </td>
        <td align="center" style="border: 1px solid #000000; background-color: #e0eda4;">
        </td>
        <td align="center" style="border: 1px solid #000000; background-color: #e0eda4;">
