...
@section('container')
    ...
    @if ($data_berita->count())
        <div class="card mb-3 text-center">
            ...
            @endif
            <div class="card-body">
                <h3 class="card-title"><a href="/data_berita/{{ $data_berita[0]->id }}"
                        class="text-decoration-none text-dark">{{ $data_berita[0]->news }}</a></h3>
                <p>
                ...
                @foreach ($data_berita->skip(1) as $berita)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <h5 class="card-title"><a href="/berita/{{ $berita->id }}"
                                        class="text-decoration-none">{{ $berita->news }}</a></h5>
                                ...
                                <a href="/berita/{{ $berita->id }}" class="text-decoration-none btn btn-primary">Read
                                    More</a>
                            </div>
                        </div>
                    </div>
