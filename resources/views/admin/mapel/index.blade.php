    ...
    <table id="mapel-table" class="table table-striped" style="width: 100%">
        ...
        <tbody>
            @foreach ($data_mapel as $mapel)
                ...
                {{-- Modal Edit --}}
                <div class="modal fade" id="modal-edit-{{ $mapel->id }}" data-bs-backdrop="static"
                                ...
                                <div class="modal-body">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control @error('nama_mapel') is-invalid @enderror"
                                            id="nama_mapel" name="nama_mapel" required value="{{ $mapel->nama_mapel }}">
                                        @error('nama_mapel')
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control @error('ringkasan') is-invalid @enderror"
                                            id="ringkasan" name="ringkasan" required value="{{ $mapel->ringkasan }}">
                                        @error('ringkasan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            ...
                            <input type="hidden" class="form-control" name="tapel_id" value="{{ $tapel->id }}"
                                readonly>
                            <input type="text" class="form-control @error('nama_mapel') is-invalid @enderror"
                                id="nama_mapel" name="nama_mapel" required autofocus value="{{ old('nama_mapel') }}">
                            @error('nama_mapel')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-2">
                            <label for="ringkasan" class="form-label">Ringkasan</label>
                            <input type="text" class="form-control @error('ringkasan') is-invalid @enderror"
                                id="ringkasan" name="ringkasan" required autofocus value="{{ old('ringkasan') }}">
                            @error('ringkasan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
